                                ...
                                <ul class="category-list">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="{{asset('Admin/images/img/'.$categorydata->catimage)}}" alt="">
                                            <h6>{{$categorydata->catname}}</h6>
                                        ...
                                        <div class="onhover-category-box">
                                            <div class="list-1">
                                                <div class="category-title-box">
                                                    <h5>{{$categorydata->catname}}</h5>
                                                </div>
                                                <ul>
                                                    @foreach($categorydata->subcategory as $subcat)
                                                    <li>
                                                        <a href="javascript:void(0)">{{$subcat->subcatname}}</a>
                                                    </li>
                                                    @endforeach
                                        ...
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item" href="{{url('/Shop category sidebar')}}">Shop
                                                            Category Sidebar</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{url('/shop_left_sidebar')}}">Shop Left
                                                            Sidebar</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li class="sub-dropdown-hover">
                                                        ...
                                                        <ul class="sub-menu">
                                                            <li>
                                                                <a href="{{url('/product_left_thumbnail')}}">Left Thumbnail</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                                    ...
                                                    <div class="row">
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{url('/shop_left_sidebar')}}">Broccoli & Cauliflower</a>

                                                            <a href="shop-left-sidebar.html"
                                                                class="dropdown-item">Chilies, Garlic</a>

                                                            <a class="dropdown-item"
                                                                href="{{url('/shop_left_sidebar')}}">Vegetables & Salads</a>

                                                            <a class="dropdown-item"
                                                                href="{{url('/shop_left_sidebar')}}">Gourd, Cucumber</a>

                                                            <a class="dropdown-item" href="{{url('/shop_left_sidebar')}}">Herbs
                                                                & Sprouts</a>
                                                        ...
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item" href="{{url('/shop_left_sidebar')}}">Beans
                                                                & Brinjals</a>
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{url('/shop_left_sidebar')}}">Chilies, Garlic</a>
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{url('/shop_left_sidebar')}}">Potatoes & Tomatoes</a>

                                                            <a href="{{url('/shop_left_sidebar')}}" class="dropdown-item">Peas
                                                                & Corn</a>
                                                        </div>
                                                        ...
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{url('/shop_left_sidebar')}}">Asparagus & Artichokes</a>

                                                            <a class="dropdown-item"
                                                                href="{{url('/shop_left_sidebar')}}">Avocados & Peppers</a>

                                                            <a class="dropdown-item"
                                                                href="{{url('/shop_left_sidebar')}}">Broccoli & Zucchini</a>

                                                            <a class="dropdown-item"
                                                                href="{{url('/shop_left_sidebar')}}">Celery, Fennel & Leeks</a>

                                                            <a class="dropdown-item"
                                                                href="{{url('/shop_left_sidebar')}}">Chilies & Lime</a>
                                                        </div>
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item" href="{{url('/blog_detail')}}">Blog Detail</a>
                                                    </li>
                                                    <li>
            ...
            <div class="row g-4">
                <div class="col-xl-8 ratio_65">
                    <div class="home-contain h-100">
                        <div class="h-100">
                            <img src="{{asset('user/images/vegetable/banner/1.jpg')}}" class="bg-img blur-up lazyload" alt="">
                        </div>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="{{asset('user/images/vegetable/banner/2.jpg')}}" class="bg-img blur-up lazyload"
                                    alt="">
                        ...
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="{{asset('user/images/vegetable/banner/3.jpg')}}" class="bg-img blur-up lazyload"
                                    alt="">
                                <div class="home-detail p-center-left home-p-sm w-75">
                                    <div>
            ...
            <div class="banner-slider">
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{asset('user/images/vegetable/banner/4.jpg')}}" class="bg-img blur-up lazyload" alt="">
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{asset('user/images/vegetable/banner/5.jpg')}}" class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{asset('user/images/vegetable/banner/6.jpg')}}" class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{asset('user/images/vegetable/banner/7.jpg')}}" class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                                <h5>Buy More & Save More</h5>
            ...
            <div class="row g-sm-4 g-3">
                    ...
                    <div class="p-sticky">
                            ...
                            <ul class="pb-4">
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="{{asset('Admin/images/img/'.$categorydata->catimage)}}" class="blur-up lazyload" alt="">
                                        <h5>
                                            <a href="shop-left-sidebar.html">{{$categorydata->catname}}</a>
                                        </h5>
                                    </div>
                                </li>
                                @endforeach
                        ...
                        <div class="ratio_156 section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="{{asset('user//images/vegetable/banner/8.jpg')}}" class="bg-img blur-up lazyload"
                                    alt="">
                        ...
                        <div class="ratio_medium section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="{{asset('user/images/vegetable/banner/11.jpg')}}" class="img-fluid blur-up lazyload"
                                    alt="">
                                <div class="home-detail p-top-left home-p-medium">
                                    <div>
                            ...
                            <div class="category-menu">
                                ...
                                <ul class="product-list border-0 p-0 d-block">
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="{{asset('user//images/vegetable/product/23.png')}}"
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="{{asset('user/images/vegetable/product/24.png')}}"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="{{asset('user/images/vegetable/product/25.png')}}"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li class="mb-0">
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="{{asset('user/images/vegetable/product/26.png')}}"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                ...
                                <div class="review-box">
                                    ...
                                    <div class="review-profile">
                                        <div class="review-image">
                                            <img src="{{asset('user/images/vegetable/review/1.jpg')}}"
                ...
                <div class="col-xxl-9 col-xl-8">
                    ...
                    <div class="title">
                        ...
                        <span class="title-leaf">
                            <svg class="icon-width">
                                <use xlink:href="{{asset('user/svg/leaf.svg#leaf')}}"></use>
                            </svg>
                        </span>
                    ...
                    <div class="section-t-space section-b-space">
                        <div class="row g-md-4 g-3">
                            <div class="col-md-6">
                                <div class="banner-contain hover-effect">
                                    <img src="{{asset('user/images/vegetable/banner/9.jpg')}}" class="bg-img blur-up lazyload"
                                        alt="">
                            ...
                            <div class="col-md-6">
                                <div class="banner-contain hover-effect">
                                    <img src="{{asset('user/images/vegetable/banner/10.jpg')}}" class="bg-img blur-up lazyload"
                                        alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>
                                            <h3 class="text-exo">50% offer</h3>
                    ...
                    <div class="product-border overflow-hidden wow fadeInUp">
                        ...
                        @foreach($getproductAsc as  $getproductAscData)
                            <div>
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="{{url('/getproduct',['product_id'=>$getproductAscData->id,'category_id'=>$getproductAscData->cat_id])}}">
                                                    <img src="{{ asset('Admin/images/img/' .  $getproductAscData->pimage) }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li>
                                            ...
                                            <div class="product-detail">
                                                <a href="product-left-thumbnail.html">
                                                    <h6 class="name h-100">{{$getproductAscData->pname}}</h6>
                                                </a>

                                                <h5 class="sold text-content">
                                                    <span class="theme-color price">${{$getproductAscData->price}}</span>
                                                    <del>28.56</del>
                                                </h5>
                                                ...
                                                <input type="hidden" name="product_id" id="product_id" value="{{$getproductAscData->id}}">
                                                <div class="add-to-cart-box">
                                                            <a class="btn btn-add-cart addcart-button addcart_button" type="submit" 
                                                            data-product_id="{{$getproductAscData->id}}"
                                                            data-price="{{$getproductAscData->price}}"
                                                                >Add
                                                                <span class="add-icon">
                                                                    <i class="fa-solid fa-plus"></i>
                                                                </span>
                    ...
                    <div class="section-t-space">
                        <div class="banner-contain">
                            <img src="{{asset('user/images/vegetable/banner/15.jpg')}}" class="bg-img blur-up lazyload" alt="">
                    ...
                    <div class="section-t-space section-b-space">
                        <div class="row g-md-4 g-3">
                            <div class="col-xxl-8 col-xl-12 col-md-7">
                                <div class="banner-contain hover-effect">
                                    <img src="{{asset('user/images/vegetable/banner/12.jpg')}}" class="bg-img blur-up lazyload"
                                        alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>
                            ...
                            <div class="col-xxl-4 col-xl-12 col-md-5">
                                <a href="shop-left-sidebar.html" class="banner-contain hover-effect h-100">
                                    <img src="{{asset('user/images/vegetable/banner/13.jpg')}}" class="bg-img blur-up lazyload"
                                        alt="">
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('user/images/vegetable/product/11.png')}}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('user/images/vegetable/product/12.png')}}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('user/images/vegetable/product/13.png')}}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('user/images/vegetable/product/14.png')}}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('user/images/vegetable/product/15.png')}}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('user/images/vegetable/product/16.png')}}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('user/images/vegetable/product/17.png')}}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('user/images/vegetable/product/18.png')}}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('user/images/vegetable/product/19.png')}}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('user/images/vegetable/product/20.png')}}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('user/images/vegetable/product/21.png')}}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{asset('user/images/vegetable/product/22.png')}}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                    ...
                    <div class="section-t-space">
                        <div class="banner-contain hover-effect">
                            <img src="{{asset('user/images/vegetable/banner/14.jpg')}}" class="bg-img blur-up lazyload" alt="">
                    ...
                    <div class="slider-3-blog ratio_65 no-arrow product-wrapper">
                            ...
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{asset('user/images/vegetable/blog/1.jpg')}}" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{asset('user/images/vegetable/blog/2.jpg')}}" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{asset('user/images/vegetable/blog/3.jpg')}}" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
